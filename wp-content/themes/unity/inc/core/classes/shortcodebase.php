...
abstract class WPO_Shortcode_Base{
	...
	?>
			...
			<button type="button" class="btn btn-primary wpo-button-save"><?php echo __('Save', 'unity'); ?></button>
			<button type="button" class="btn btn-default wpo-button-back"><?php echo __('Back to list', 'unity'); ?></button>
	...
	private function renderUploader( $_id, $_name ) {
		...
		$output .= '<input id="' . esc_attr( $id ) . '" class="upload" type="text" name="'.esc_attr( $name ).'" placeholder="' . __('No file chosen', 'unity') .'" />' . "\n";
		if ( function_exists( 'wp_enqueue_media' ) ) {
			if ( ( $value == '' ) ) {
				$output .= '<input id="upload-' . esc_attr( $id ) . '" class="upload-button button" type="button" value="' . __( 'Upload', 'unity' ) . '" />' . "\n";
			} else {
				$output .= '<input id="remove-' . esc_attr( $id ) . '" class="remove-file button" type="button" value="' . __( 'Remove', 'unity' ) . '" />' . "\n";
			}
		} else {
			$output .= '<p><i>' . __( 'Upgrade your version of WordPress for full media support.', 'unity' ) . '</i></p>';
		}
