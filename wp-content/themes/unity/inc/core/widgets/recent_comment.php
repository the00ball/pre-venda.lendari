...
class WPO_Recent_Comment extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Recent Comments Widget', 'unity'),
            // Widget description
            array( 'description' => __( 'Show list of recent comments', 'unity' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php _e( 'Num Comments:', 'unity' ); ?></label>
