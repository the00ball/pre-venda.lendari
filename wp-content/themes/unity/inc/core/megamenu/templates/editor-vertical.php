...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1><?php echo __( 'Vertical Megamenu Editor', 'unity' );?></h1>
			</div>
			<div class="col-md-12">
		...
		<div class="tab-pane" id="manage-widget">
	  	...
	  	<div class="tab-pane active" id="megamenu-editor">
				<div id="menu-form"  style="display: none; left: 340px; top: 15px; max-width:600px" class="popover top out form-setting">
							<div class="arrow"></div>
							<h3 style="display: block;" class="popover-title">Sub Menu Setting <span class="badge pull-right"><?php echo __('Close', 'unity');?></span></h3>
							<div class="popover-content">
								...
								<table class="table table-hover">
									...
									<tr>
										<td><?php echo __('Icon', 'unity');?></td>
										<td>
											 <input type="text" name="menu_icon" class="menu_icon">
										</td>
									</tr>
									<tr>
										<td><?php echo __('Description', 'unity');?></td>
										<td>
