	...
	class WPO_VisualComposer extends WPO_PageBuilder_Base{
		...
		private function elementColumn(){
			$add_css_animation = array(
				"type" => "dropdown",
				"heading" => __("CSS Animation", 'unity'),
				"param_name" => "css_animation",
				"admin_label" => true,
				"value" => $this->cssAnimation,
				"description" => __("Select animation type if you want this element to be animated when it enters into the browsers viewport. Note: Works only in modern browsers.", 'unity')
			);
		...
		private function elementMap(){
			...
			vc_add_param( 'vc_gmaps', array(
					...
					"admin_label" => true,
					"description" => __("Select Map Type.", 'unity')
				)
		    );
