...
abstract class WPO_PageBuilder_Base{
	...
	public function __construct(){
		...
		vc_add_shortcode_param('googlemap',array($this,'parramGoogleMap'),WPO_FRAMEWORK_ADMIN_STYLE_URI.'js/pagebuilder/googlemap.js');
	...
	private function setValueCssAnimationInput(){
		$this->cssAnimation = array(
								__("No", 'unity') => '',
								__("Top to bottom", 'unity') => "top-to-bottom",
								__("Bottom to top", 'unity') => "bottom-to-top",
								__("Left to right", 'unity') => "left-to-right",
								__("Right to left", 'unity') => "right-to-left",
								__("Appear from center", 'unity') => "appear",
								'bounce' => 'bounce',
								'flash' => 'flash',
								'pulse' => 'pulse',
