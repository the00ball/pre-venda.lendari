...
<?php endif; ?>
		...
		<form method="post" class="login" role="form">
			...
			<p class="form-group form-row form-row-wide">
				<label for="username"><?php _e( 'Username or email address', 'unity' ); ?> <span class="required">*</span></label>
			...
			<p class="form-group form-row">
				...
				<input type="submit" class="button" name="login" value="<?php _e( 'Login', 'unity' ); ?>" />
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<form method="post" class="register widget" role="form">
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="form-group form-row form-row-wide">
					<label for="reg_username"><?php _e( 'Username', 'unity' ); ?> <span class="required">*</span></label>
			...
			<p class="form-group form-row form-row-wide">
				<label for="reg_email"><?php _e( 'Email address', 'unity' ); ?> <span class="required">*</span></label>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="form-group form-row form-row-wide">
					<label for="reg_password"><?php _e( 'Password', 'unity' ); ?> <span class="required">*</span></label>
			...
			<!-- Spam Trap -->
			<div style="<?php echo ( ( is_rtl() ) ? 'right' : 'left' ); ?>: -999em; position: absolute;"><label for="trap"><?php _e( 'Anti-spam', 'unity' ); ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>
			...
			<p class="form-group form-row">
				...
				<input type="submit" class="button" name="register" value="<?php _e( 'Register', 'unity' ); ?>" />
			</p>
