	...
	<form id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form" method="post" action="<?php echo esc_url( $current_url ); ?>">
		...
		<div class="first-column col-lg-9 col-sm-8 col-xs-12">
			<div id="tribe-bar-collapse-toggle" <?php if ( count( $views ) == 1 ) { ?> class="tribe-bar-collapse-toggle-full-width"<?php } ?>>
				<?php _e( 'Find Events', 'unity' ) ?><span class="tribe-bar-toggle-arrow"></span>
			</div>
			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<button class="tribe-no-param btn btn-donate-black" type="submit" name="submit-bar"><span class="icon"><i class="fa fa-setting"></i></span><span class="btext"><?php _e( 'Find Events', 'unity' ) ?></span></button>
		...
		<div class="second-column col-lg-3 col-sm-4 col-xs-12">
			...
			<div id="tribe-bar-views">
				<div class="tribe-bar-views-inner tribe-clearfix">
					<h3 class="tribe-events-visuallyhidden"><?php _e( 'Event Views Navigation', 'unity' ) ?></h3>
					<label><?php _e( 'View As', 'unity' ); ?>:</label>
