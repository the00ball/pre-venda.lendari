                    ...
                    <div class="container">
                        <div class="mainmenu-content-wapper">
                            ...
                            <?php $link_create = (wpo_theme_options('enable_link_campaign', false)) ? ( wpo_theme_options('link_button_campaign', '#')): wpo_crowdfunding_get_page_url('submit_page'); ?>
                                <a class="user-campaign button" href="<?php echo esc_url( $link_create); ?>"><i class="fa fa-plus"></i><span class="hidden-sm hidden-md"><?php echo wpo_theme_options('text_button_campaign', __('Creat a campaign', 'unity') ); ?></span></a>
                            </div>
                        <?php endif; ?>  
                        </div>    
                    </div>
