...
Description:		A crowdfunding platform in the likes of Kickstarter and Indigogo. Originally developed by Astoundify; now maintained by Studio 164a for customers using the Unity Crowdfunding Theme.
Author:				Studio 164a
...
require 'plugin-updates/plugin-update-checker.php';
  $ExampleUpdateChecker = PucFactory::buildUpdateChecker(
    'http://wpopal.com/thememods/appthemer-crowdfunding.json',
    __FILE__,
...
<?php
	...
	public function frontend_scripts() {
		...
		$is_submission = ( isset($edd_options[ 'submit_page' ]) && is_page( $edd_options[ 'submit_page' ] ) ) || did_action( 'atcf_found_edit' );
		...
		if ( $is_campaign ) {
			...
			$settings[ 'campaign' ] = array(
				...
				'currency'    => array(
					'thousands' => isset($edd_options[ 'thousands_separator' ])? $edd_options[ 'thousands_separator' ] : null,
					'decimal'   => isset($edd_options[ 'decimal_separator' ]) ? $edd_options[ 'decimal_separator' ] : null,
